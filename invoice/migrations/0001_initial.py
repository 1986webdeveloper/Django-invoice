    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance_due', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='InvoiceLine',
            fields=[
                ...
                ('line_total', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True)),
