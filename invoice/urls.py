...
urlpatterns = [
                  ...
                  url(r'^delete_invoice/(?P<invoice_id>[0-9]+)', views.InvoiceDeleteView.as_view(),
                      name='delete_invoice'),
                  url(r'^download_invoice/(?P<invoice_id>[0-9]+)/', views.DownloadInvoiceView.as_view(),
                      name='download_invoice'),
                  url(r'^dashboard/invoice_detail/(?P<invoice_id>[0-9]+)/', views.InvoiceDetailView.as_view(),
                      name='invoice_detail'),
