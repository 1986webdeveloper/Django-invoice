...
class Invoice(models.Model):
    ...
    shipping_charge = models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True)
    tax = models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True)
    balance_due = models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True)
...
class InvoiceLine(models.Model):
	...
	line_total= models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True)
